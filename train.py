...
parser.add_argument("--num_train_dataset", type=int, default=50000)
...
if __name__ == "__main__":
    ...
    with open("te/%d-%d/1.20" % (args.num_procs, args.num_tasks), 'rb') as f:
    ...
    for epoch in range(args.num_epochs):
        ...
        print("[at epoch %d][RL model generates %d][OPA generates %d]" % (epoch, rl_model_sum, np.sum(res_opa)))
